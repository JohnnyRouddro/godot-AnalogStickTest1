extends Spatial
onready var touchscreen = get_node("../../Stick/TouchScreenButton")
var maxTouch = 3
var touch = []
var cam_pitch = 0.0;
var cam_yaw = 0.0;
...
var cam_pos = Vector3();
var cam_ray_result = {};
export var cam_smooth_movement = false;
var cam_fov = 60.0;
export var cam_view_sensitivity = 0.3;
export var cam_smooth_lerp = 0;
...
func _input(ie):
	...
	if ie.type == InputEvent.SCREEN_DRAG:
		if touchscreen.touch[ie.index].type == "view":
